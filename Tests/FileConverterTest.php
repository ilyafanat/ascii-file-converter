...
class FileConverterTest extends TestCase
{
    ...
    */
    public function testConvert($data, $result)
    {
        ...
        $this->assertEquals($result, $returnString);
    }
}